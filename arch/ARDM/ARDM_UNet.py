from .layers import ResnetBlockDDPM, AttnBlock, Upsample, Downsample, ddpm_conv3x3, get_timestep_embedding
...
class ARDM_UNet(nn.Module):
    def __init__(self, num_classes, ch, out_ch, ch_mult, num_res_blocks, full_attn_resolutions, num_heads, dropout, max_time=3072., weave_attn=False):
        super().__init__()
        ...
        channels = nf = self.ch     # should be 256
